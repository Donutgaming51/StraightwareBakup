...
--pcall(function() if game:GetService("Players").LocalPlayer.Name == "LostForOne" or game:GetService("Players").LocalPlayer.Name == "Skiff" or game:GetService("Players").LocalPlayer.Name == "ialwayscomeback1409" then game:GetService("Players").LocalPlayer:Kick("crazy bypasser u have - erchodev#0 / VW OWNER") end end)
...
local url = shared.RiseMode and "https://github.com/Donutgaming51/VWRise/" or "https://github.com/Donutgaming51/StraightwareBakup"
